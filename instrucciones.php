...
$monto = $venta['IMP_RECIBIDO_NETO_MP'] +  $venta['FEE_MP'];
...
<body class="bg-dark">
    ...
    <div class="container rounded  bg-dark text-white py-5  " style="">
        <div class="order-md-2 px-3">
                ...
                <p class="lead mt-2">
                    También podés acceder al contenido ahora, clickeando el siguiente botón
                </p>
                <?php
                foreach ($botones as $btn) {
                    ...
                    <div class="tb_es_btn_wrapper mt-4">
                        <a href="<?= $btn['urlDownload'] ?>" target="_blank">  <button type="button" class="col-md-8 py-3 lead  bg-success text-white text-uppercase" >👉 VER CURSO <?= $btn['desc'] ?></button></a>
                    </div>
                    <?php
                    }
                }
                ...
                foreach ($botones as $btn) {
                    ...
                    ?>
                    <div class="tb_es_btn_wrapper mt-4">
                        <a href="<?= $btn['urlFacebook'] ?>" target="_blank">  <button type="button" class="col-md-8 py-3 lead  bg-success text-white text-uppercase" >👉 UNIRSE AL GRUPO <?= $btn['desc'] ?></button></a>
                    </div>
                    <?php
                    }
                }
                if($conteoF > 0){?>
                <p><b>Importante:</b> por favor tené en cuenta que <b>la aprobación de tu ingreso al Grupo no es automática</b>. Una persona se encarga de hacerlo, por lo cual te pedimos que si compraste por la noche seas paciente y esperes al día siguiente. Ante cualquier duda consultanos en nuestro Facebook, Instagram, o bien a hola@cursosfacilesencasa.com </p> 
                <?php
